...
export default function Sidebar() {
    return (
        <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hideen lg-flex">
           <div className="bg-[#121212] h-[15%] rounded-xl flex flex-col justify-around">
           ...
           <div className="bg-[#121212] h-[85%] rounded-xl mt-2">
                ...
                <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col justify-start gap-1 pl-4">
                    ...
                    <button className="px-3 py-1.5 bg-white text-[15px] text-black rounded-full mt-4 w-52 ">Tạo danh sách phát</button>
                </div>
                ...
                <div className="mt-10 flex px-4 flex-wrap gap-4">
                    ...
                    <a  className="text-xs text-gray-200 px-4"   href="">Giới thiệu Quảng cáo</a>
                    <a  className="text-xs text-gray-200 px-4"   href="">Hỗ trợ tiếp cận</a>
                    <a  className="text-xs text-gray-200 px-4"   href="">Cookie</a>
                </div>
                <div className="p-7">
                <button className="mt-4 px-3 p-1 flex gap-2 border-white border rounded-full">
